...
python ../../swmm_mpc/test_scripts/pyswmm_make_hotstart.py $mod_model
...
python ../../swmm_mpc/test_scripts/plot_rpt.py swmm_hs.rpt "NODE J1" Depth
python ../../swmm_mpc/test_scripts/plot_rpt.py pyswmm_hs.rpt "NODE J1" Depth
python ../../swmm_mpc/test_scripts/plot_rpt.py mod_hs.rpt "NODE J1" Depth
